...
export default function SocialBar({ show }) {
  return (
    <div
      className={`fixed top-0 left-0 w-full bg-gray-900 text-white z-20 transition-transform duration-300
    ...
    >
      <div className="flex justify-center items-center gap-6 py-2 text-lg">
        ...
        <a href="https://www.instagram.com/bigints.com_/" target="_blank"><FaInstagram size={22}/></a>
